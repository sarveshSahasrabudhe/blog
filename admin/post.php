                        ...
                        if($result_show_posts)
                        {
                            while($row=mysqli_fetch_assoc($result_show_posts))
                            {
                                ...
                                echo "
                                        ...
                                        <hr>
                                        <img class='img-responsive' src='admin_images/$post_image' alt=''>
                                        <hr>
                                        <p>$post_content</p>
                            ...
                            while($row=mysqli_fetch_assoc($result_display))
                            {
                                ...
                                <div class='media'>
                                    <a class='pull-left' href='#'>
                                        <img class='media-object' src='admin_images/$user_img' height='75px' width='75px' style='border-radius:50%;'>
                                    </a>
