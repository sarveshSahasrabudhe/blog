        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <?php if($_SESSION['user_firstname'] != null)
                    echo $_SESSION['user_firstname']."'s"; ?> Timeline
                </h1>
                ...
                <?php
                    if($_SESSION['username_backend'] == null)
                    {
                        ...
                        $query_show_post = "SELECT * FROM posts WHERE post_status='Approve' ORDER BY post_date DESC";
                        ...
                        if($result_show_post)
                        {
                            ...
                            <hr>
                            <img class='img-responsive' height='600px' width='600px' src='admin/admin_images/$post_image' alt='Error in image'>
                            <hr>
                            <p>$post_content</p>
                    ...
                    else 
                    {
                        ...
                        if($result_show_post)
                        {
                            ...
                            <p><span class='glyphicon glyphicon-time'></span> Posted on $post_date</p>
                            <hr>
                            <img class='img-responsive' src='admin/admin_images/$post_image' alt=''>
                            <hr>
                            <p>$post_content</p>
                            <a class='btn btn-primary' href='post.php?post_view=$post_id'>Comment</a>";
                            }
