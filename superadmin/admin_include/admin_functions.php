                ...
                echo "
                    <form method='post' enctype='multipart/form-data'>
                        ...
                        echo "</select>
                            ...
                            Post Image: <br>
                            <img src='../admin/admin_images/$post_image' height='100px' width='100px'><br><br>
...
function profile()
{
    ...
    if($result)
    {
        ...
        while($row=mysqli_fetch_assoc($result))
        {
            ...
            echo "
                <div align='center'>
                    <img src='../admin/admin_images/$user_pic' height='300px' width='300px;' style='border-radius: 100%;'>
                </div>
                <br><br>
                ";
        echo "
...
function update_profile()
{
    ...
    if($result)
    {
        ...
        echo "
            <div align='center'>
                <img src='../admin/admin_images/$user_pic' height='300px' alt='Your Profile Will be Updated Soon' width='300px;' style='border-radius: 100%;'>
            </div>
            ";
        echo "
            <div class='well'>
...
function view_comments()
{
    global $connection;
    $username=$_SESSION['username_backend'];
    $query_show_comments = "SELECT * FROM comments ";
...
{
    global $connection;
    $query_show_posts = "SELECT * FROM posts";
    ...
    if($result_show_posts)
    {
        ...
        while($row=mysqli_fetch_assoc($result_show_posts))
        {
            ...
            echo "
                        ...
                        <td>$post_author</td>
                        <td>$post_date</td>
                        <td><img src='../admin/admin_images/$post_image' height='100px' width='100px'></td>
                        <td>$post_content</td>
                        <td>$post_tags</td>
